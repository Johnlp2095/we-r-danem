...
tag @a add ShrinkFor
scoreboard players set dummy pregamecount 75
bossbar set minecraft:pregame max 75
schedule function game:skywars/borderincriment/border1time 75s replace
worldborder add -136 75s