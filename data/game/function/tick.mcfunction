...
execute if entity @a[scores={SWDeath=1..}] run function game:skywars/swdeath
execute if score #TimerUp TimerUp matches 1 run function game:timer/bossbar_up/BBTimerUP